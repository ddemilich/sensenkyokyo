...
*battle_win
    ...
    [turn_text msg="！！勝利！！"]
    [anim name="&tf.currentEvent.params.lambda.charaInstance.name" left="375" top="100" time="200"]
    [anim name="&tf.currentEvent.params.mu.charaInstance.name" left="635" top="100" time="200"]
    [wa]
    [jump target="*process_battle_events_start"]
*battle_lose
    [layopt layer="2" visible="false"]
    ...
    [if exp="tf.currentEvent.params.lambda.charaInstance.bundled"]
        ...
        [anim name="&tf.currentEvent.params.lambda.bundleInstance.name" left="375" top="150"]
    [else]
        [anim name="&tf.currentEvent.params.lambda.charaInstance.name" left="400" top="150"]
    [endif]
    [if exp="tf.currentEvent.params.mu.charaInstance.bundled"]
        ...
        [anim name="&tf.currentEvent.params.mu.bundleInstance.name" left="655" top="150"]
    [else]
        [anim name="&tf.currentEvent.params.mu.charaInstance.name" left="655" top="150"]
    [endif]
    [wa]
    [jump target="*process_battle_events_start"]
*battle_end_sequence
