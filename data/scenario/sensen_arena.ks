...
[macro name="arena_menu_enemy_buttons"]
    [ptext name="enemies" overwrite="true" layer="1" color="black" text="敵キャラ" x="&tf.ArenaController.getBgSelectX(1)" y="&tf.ArenaController.getBgSelectY(4)"  width="&tf.ArenaController.gridWidth"]
    ...
    [button graphic="button/vs_e21.png" x="&tf.ArenaController.getBgSelectX(2)" y="&tf.ArenaController.getBgSelectY(5)" exp="tf.ArenaController.addEnemy('e21')" width="&tf.ArenaController.gridWidth" height="&tf.ArenaController.gridHeight" target="&mp.target"]
    [button graphic="button/vs_e22.png" x="&tf.ArenaController.getBgSelectX(3)" y="&tf.ArenaController.getBgSelectY(5)" exp="tf.ArenaController.addEnemy('e22')" width="&tf.ArenaController.gridWidth" height="&tf.ArenaController.gridHeight" target="&mp.target"]
    [button graphic="button/vs_e23.png" x="&tf.ArenaController.getBgSelectX(4)" y="&tf.ArenaController.getBgSelectY(5)" exp="tf.ArenaController.addEnemy('e23')" width="&tf.ArenaController.gridWidth" height="&tf.ArenaController.gridHeight" target="&mp.target"]
    [button graphic="button/vs_e24.png" x="&tf.ArenaController.getBgSelectX(5)" y="&tf.ArenaController.getBgSelectY(5)" exp="tf.ArenaController.addEnemy('e24')" width="&tf.ArenaController.gridWidth" height="&tf.ArenaController.gridHeight" target="&mp.target"]
[endmacro]

[macro name="arena_menu_enemy_levels"]
    [button graphic="button/decdec.png" x="&tf.ArenaController.getBgSelectX(1)" y="&tf.ArenaController.getBgSelectY(7)" exp="tf.ArenaController.setLevel(-10)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [button graphic="button/dec.png" x="&tf.ArenaController.getBgSelectX(2)" y="&tf.ArenaController.getBgSelectY(7)" exp="tf.ArenaController.setLevel(-1)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [ptext name="enemyLevelTitle" overwrite="true" layer="1" color="black" text="敵レベル" x="&tf.ArenaController.getBgSelectX(3)" y="&tf.ArenaController.getBgSelectY(7)" width="&tf.ArenaController.gridWidth"]
    [button graphic="button/inc.png" x="&tf.ArenaController.getBgSelectX(4)" y="&tf.ArenaController.getBgSelectY(7)" exp="tf.ArenaController.setLevel(1)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [button graphic="button/incinc.png" x="&tf.ArenaController.getBgSelectX(5)" y="&tf.ArenaController.getBgSelectY(7)" exp="tf.ArenaController.setLevel(10)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
[endmacro]
[macro name="arena_menu_lp"]
    [button graphic="button/decdec.png" x="&tf.ArenaController.getBgSelectX(1)" y="&tf.ArenaController.getBgSelectY(9)" exp="tf.ArenaController.setLP(-10)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [button graphic="button/dec.png" x="&tf.ArenaController.getBgSelectX(2)" y="&tf.ArenaController.getBgSelectY(9)" exp="tf.ArenaController.setLP(-1)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [ptext name="heroineLpTitle" overwrite="true" layer="1" color="black" text="LP" x="&tf.ArenaController.getBgSelectX(3)" y="&tf.ArenaController.getBgSelectY(9)" width="&tf.ArenaController.gridWidth"]
    [button graphic="button/inc.png" x="&tf.ArenaController.getBgSelectX(4)" y="&tf.ArenaController.getBgSelectY(9)" exp="tf.ArenaController.setLP(1)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [button graphic="button/incinc.png" x="&tf.ArenaController.getBgSelectX(5)" y="&tf.ArenaController.getBgSelectY(9)" exp="tf.ArenaController.setLP(10)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
[endmacro]

[macro name="arena_menu_ap"]
    [button graphic="button/decdec.png" x="&tf.ArenaController.getBgSelectX(1)" y="&tf.ArenaController.getBgSelectY(11)" exp="tf.ArenaController.setAP(-10)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [button graphic="button/dec.png" x="&tf.ArenaController.getBgSelectX(2)" y="&tf.ArenaController.getBgSelectY(11)" exp="tf.ArenaController.setAP(-1)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [ptext name="heroineApTitle" overwrite="true" layer="1" color="black" text="AP" x="&tf.ArenaController.getBgSelectX(3)" y="&tf.ArenaController.getBgSelectY(11)" width="&tf.ArenaController.gridWidth"]
    [button graphic="button/inc.png" x="&tf.ArenaController.getBgSelectX(4)" y="&tf.ArenaController.getBgSelectY(11)" exp="tf.ArenaController.setAP(1)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [button graphic="button/incinc.png" x="&tf.ArenaController.getBgSelectX(5)" y="&tf.ArenaController.getBgSelectY(11)" exp="tf.ArenaController.setAP(10)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
[endmacro]

[macro name="arena_menu_er"]
    [button graphic="button/decdec.png" x="&tf.ArenaController.getBgSelectX(1)" y="&tf.ArenaController.getBgSelectY(13)" exp="tf.ArenaController.setER(-10)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [button graphic="button/dec.png" x="&tf.ArenaController.getBgSelectX(2)" y="&tf.ArenaController.getBgSelectY(13)" exp="tf.ArenaController.setER(-1)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [ptext name="heroineErTitle" overwrite="true" layer="1" color="black" text="ER" x="&tf.ArenaController.getBgSelectX(3)" y="&tf.ArenaController.getBgSelectY(13)" width="&tf.ArenaController.gridWidth"]
    [button graphic="button/inc.png" x="&tf.ArenaController.getBgSelectX(4)" y="&tf.ArenaController.getBgSelectY(13)" exp="tf.ArenaController.setER(1)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [button graphic="button/incinc.png" x="&tf.ArenaController.getBgSelectX(5)" y="&tf.ArenaController.getBgSelectY(13)" exp="tf.ArenaController.setER(10)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
[endmacro]

[macro name="arena_menu_cr"]
    [button graphic="button/decdec.png" x="&tf.ArenaController.getBgSelectX(1)" y="&tf.ArenaController.getBgSelectY(15)" exp="tf.ArenaController.setCR(-10)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [button graphic="button/dec.png" x="&tf.ArenaController.getBgSelectX(2)" y="&tf.ArenaController.getBgSelectY(15)" exp="tf.ArenaController.setCR(-1)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
    [ptext name="heroineCrTitle" overwrite="true" layer="1" color="black" text="CR" x="&tf.ArenaController.getBgSelectX(3)" y="&tf.ArenaController.getBgSelectY(15)" width="&tf.ArenaController.gridWidth"]
    [button graphic="button/inc.png" x="&tf.ArenaController.getBgSelectX(4)" y="&tf.ArenaController.getBgSelectY(15)" exp="tf.ArenaController.setCR(1)" width="&tf.ArenaController.gridWidth" target="&mp.target"]
